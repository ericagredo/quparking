...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInputDate(oTable) {


            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="form-control" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker({
                dateFormat: "yy-mm-dd",
            });
            th.append(from);
            ...
            $('#' + sFromId, th).change(function () {
                oTable.fnFilter(this.value, _fnColumnIndex(index)); //Issue 37
                fnOnFiltered();
                //oTable.fnDraw();
        ...
        function fnCreateInputTime(oTable) {
                ...
                if (aoColumn != null) {
                    ...
                    switch (aoColumn.type) {
                        ...
                        case "number":
                            ...
                            break;
                        case "datepicker":
                            fnCreateInputDate(oTable);
                            break;
                        case "timepicker":
                            fnCreateInputTime(oTable);
                            break;
                        case "select":
