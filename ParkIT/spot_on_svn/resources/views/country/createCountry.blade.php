    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ url('country/managecountry') }}">Country</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                           ...
                           <form role="form" id="Form_Control" method="post" action="{{ url('/country/create') }}">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Country Code" type="text" name="country_code" minlength="1" maxlength="10" onblur="javascript:CheckCountryCodeExist(this.value, '')">
                            ...
                            <div class="box-footer">
                                <a href="{{ url('country/managecountry') }}"><button class="btn btn-default pull-right" style="margin:0 0 0 5px" type="button">Cancel</button></a>
