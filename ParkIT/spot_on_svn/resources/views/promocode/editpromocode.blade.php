...
@section('title', 'QU - Edit Promo Codes')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        ...
                        @endif
                        <form role="form" id="Promocode_form" method="post" action="{{ url('/promocode/update/'.$promocode->id) }}">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Promo Name" type="text" name="promo_name" minlength="3" value="{{ $promocode->promo_name }}">
                                        </div>
                                    </div> 
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                           <div class="form-group">
                                               <label>Discount <span class="asterisk red">*</span></label>
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" placeholder="Discount" type="text" name="discount" onkeypress="return isNumber(event)" maxlength="3" value="{{ $promocode->discount }}">
                                                </div>
                                            </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="status">
                                                ...
                                                <option {{ ($promocode->status == 'Active') ? 'selected="selected"' : '' }} value="Active">Active</option>
                                                <option {{ ($promocode->status == 'Inactive') ? 'selected="selected"' : '' }} value="Inactive">Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right" id="datepicker" name="promo_start_date" value="{{ ($promocode->promo_start_date != '0000-00-00') ? date('m/d/Y', strtotime($promocode->promo_start_date)) : '' }}">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right" id="datepicker1" name="promo_end_date" value="{{ ($promocode->promo_end_date != '0000-00-00') ? date('m/d/Y', strtotime($promocode->promo_end_date)) : '' }}">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                    </div>
