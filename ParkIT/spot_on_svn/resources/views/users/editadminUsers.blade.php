            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        ...
                        @endif
                        <form role="form" id="Users_form" method="post" action="{{ url('/users/update/'.$user->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="First Name" type="text" name="first_name" minlength="3" value="{{ $user->firstname }}">
                                        </div>
                                    </div> 
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label>Last Name<span class="asterisk red">*</span></label>
                                            <input class="form-control" placeholder="Last Name" type="text" name="last_name" minlength="3" value="{{ $user->lastname }}">
                                        </div>
                                    </div> 
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label>Email<span class="asterisk red">*</span></label>
                                            <input class="form-control" placeholder="Email" type="text" name="email" id="email" value="{{ $user->email }}" onblur="javascript:CheckEmailExist(this.value, {{$user->id}})">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 hidden">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Username" type="text" name="username" id="username" value="{{ $user->username }}" minlength="3" onblur="javascript:CheckUsernameExist(this.value, {{$user->id}})">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Contact number" type="Contact_number" name="contact_number" value="{{ $user->contact_number }}" onkeypress="return isNumber(event)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Location" type="text" name="location" id="location" value="{{ $user->location }}">
                                            <input class="form-control" type="hidden" name="latitude" id="latitude" value="{{ $user->latitude }}">
                                            <input class="form-control" type="hidden" name="longitude" id="longitude" value="{{ $user->longitude }}">
                                        </div>
                                    </div>
                                    ...
                                    <!--<div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Country name" type="text" name="country_name" id="country_name" value="{{ $user->country_id }}">
                                        </div>
                                    </div>-->
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="country_id" id="country_id">
                                                ...
                                                ?>
                                                <option {{ $user->country_id == $single->id ? 'selected="selected"' : '' }} value="{{$single->id}}">{{$single->country_name}}&nbsp;-&nbsp;{{$single->country_code}}</option>
                                                <?php } } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="zipcode" type="text" name="zipcode" id="zipcode" value="{{ $user->zipcode }}">
                                        </div>
                                    </div>
                                    <div style="clear: both"></div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset('uploads/user_profile_image/'.$user->profile_image) }}" width="100px" height="65px"> 
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 custom_hide" >
                                        <div class="form-group">
                                            ...
                                            <input type="radio" {{ $user->gender == 'Male' ? 'checked' : '' }} class="" id="male" name="gender" value="Male"> Male
                                            <input type="radio" {{ $user->gender == 'Female' ? 'checked' : '' }} class="" id="female" name="gender" value="Female"> Female
                                        </div>
                                    </div>
                                </div> 
                            </div>
