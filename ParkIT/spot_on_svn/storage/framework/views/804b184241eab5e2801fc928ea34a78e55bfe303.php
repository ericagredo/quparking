        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo e(ucfirst(Session::get('userData')->first_name.' '.Session::get('userData')->last_name)); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?php echo e(ucfirst(Session::get('userData')->first_name.' '.Session::get('userData')->last_name)); ?>                 
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(url('/admin/viewProfile')); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
