<?php $__env->startSection('title', 'Park It - Booking Refund Receipt'); ?>
    ...
    <div class="row" style="margin-top: 15px">
        <div class="col-xs-12">
            <div class="box box-primary box-solid">
                <form role="form" id="ReceiptForm" method="post" action="<?php echo e(url('/refund/Savereceipt/'.$booking_refund_id)); ?>" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div style="margin: 20px">  
                                <a href="<?php echo e(url('refund/RefundListAdmin')); ?>" class="btn btn-default pull-right" style="margin:0 0 0 5px">Cancel</a>
