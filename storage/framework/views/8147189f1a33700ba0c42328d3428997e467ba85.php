<?php $__env->startSection('title', 'Park It - Add Pricing'); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        ...
                        <?php endif; ?>
                        <form role="form" id="PricingForm" method="post" action="<?php echo e(url('/pricing/create')); ?>">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-4" style="width: 33%">
                                        <div class="form-group" style="float: left;width: 35%;">
                                            ...
                                            <input id="noofhour" class="form-control" placeholder="Hourly Pricing" data-format="H" data-template="H" name="no_of_hours" value="" type="text" style="width: 70%;float:left">
                                        </div>
                                        <div class="form-group" style="float: left;width: 65%;">
                                            <label></label> <div style="clear:both"></div>
                                            <div class="input-group" style="margin-top:5px">
                                                <span class="input-group-addon">$</span>
                                                <input class="form-control" placeholder="Hourly Price" type="text" name="hourly_price" onkeypress="return isNumber(event)"> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4" style="width: 33%">
                                        <div class="form-group" style="float: left;width: 35%;">
                                            ...
                                            <input id="noofdays" class="Customdaymonthhour" data-format="D" data-template="D" name="no_of_days" value="" type="text" style="width: 70%;float:left">
                                        </div>
                                        <div class="form-group" style="float: left;width: 65%;">
                                            <label></label> <div style="clear:both"></div>
                                            <div class="input-group" style="margin-top:5px">
                                                <span class="input-group-addon">$</span>
                                                <input class="form-control" placeholder="Daily Price" type="text" name="daily_price" onkeypress="return isNumber(event)">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4" style="width: 33%">
                                        <div class="form-group" style="float: left;width: 35%;">
                                            ...
                                            <input id="noofmonths" class="Customdaymonthhour" data-format="M" data-template="M" name="no_of_month" value="" type="text" style="width: 20%;float:left">
                                        </div>
                                        <div class="form-group" style="float: left;width: 65%;">
                                            <label></label> <div style="clear:both"></div>
                                            <div class="input-group" style="margin-top:5px">
                                                <span class="input-group-addon">$</span>
                                                <input class="form-control" placeholder="Monthly Price" type="text" name="monthly_price" onkeypress="return isNumber(event)">
                                            </div>
                                        </div>
                                    </div>
