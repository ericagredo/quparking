...
<script src="<?php echo e(asset('js/custom_validate.js')); ?>"></script> 
<!-- <script src="<?php echo e(asset('js/custom.js')); ?>"></script>  --->  
<script src="<?php echo e(asset('js/grid_function.js')); ?>"></script> 

<!-- Datatable js  ---->
<script src="<?php echo e(asset('plugins/datatables/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/datatables/dataTables.bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery.dataTables.columnFilter.js')); ?>"></script>

<!----- Responsive js ------->
<script src="<?php echo e(asset('plugins/datatables/extensions/Responsive/js/dataTables.responsive.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/datatables/dataTables.responsive.min.js')); ?>"></script>

<!-- ComboDate js  ---->
<script src="<?php echo e(asset('plugins/combodate/combodate.js')); ?>"></script>

<script src="<?php echo e(asset('js/date-timepicker.js')); ?>"></script>
...
<?php echo $__env->yieldPushContent('scripts'); ?>  <!---- Added For You Can use added script on View page ------->
