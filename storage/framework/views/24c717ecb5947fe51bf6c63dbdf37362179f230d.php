<?php $__env->startSection('title', 'QU - Manage Admin Users'); ?>
    ...
    <section class="content">
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <a href="<?php echo e(url('admin/createAdminUser')); ?>"><button class="btn btn-primary" type="button">Add</button></a>
            </div>
        </div>
                ...
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="AdminUserList" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Name</th>
...
<script type="text/javascript">
    ...
    var deleteAjaxSource = '/admin/delete';
    var activeInactiveAjaxSource = '/admin/activeInactiveStatus';

    $(document).ready(function () {
        // $('#AdminUserList').dataTable();
        dTable = $('#AdminUserList').dataTable({
            responsive: false,
            bJQueryUI: false,
            bProcessing: true,
            bServerSide: true,
        ...
        // ======== Seprate Search code =========//
        $('#AdminUserList').dataTable().columnFilter({
    ...
    $('#AdminUserList_paginate ul li').on('click', function () {
