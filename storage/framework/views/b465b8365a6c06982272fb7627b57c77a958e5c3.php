<?php $__env->startSection('title', 'Park It - Manage Promo Codes'); ?>
    ...
    <section class="content">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group nomargin">
                                        ...
                                        <div class="" id="serpromoname">  </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group nomargin">
                                        <label class="control-label">Promo Code</label>
                                        <div class="" id="serpromocode">  </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group nomargin">
                                        <label class="control-label">Discount</label>
                                        <div class="" id="serdiscount"> </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group nomargin">
        ...
        <div class="row contentpanel">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <a href="<?php echo e(url('promocode/createpromocode')); ?>" class="btn btn-primary">Add Promo Codes</a>
            </div>
        </div>
        <!--Data Table-->
        <div class="row">
                ...
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="PromocodeList" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Promo Name</th>
...
<script type="text/javascript">
    ...
    var addEditSource = '/promocode/editpromocode';
    var deleteAjaxSource = '/promocode/deletepromocode';
    var activeInactiveAjaxSource = '/promocode/activeInactivepromocode';
    var sendPromocodeSource = '/promocode/sendPromocodeSource';

    $(document).ready(function () {
       dTable = $('#PromocodeList').dataTable({
            responsive: false,
            bJQueryUI: false,
            bProcessing: true,
            bServerSide: true,
            "bAutoWidth": false,
            iDisplayLength: 10,
            sAjaxSource: '/promocode/ajaxpromocodeList/',
            aoColumns: [
            ...
            aoColumnDefs: [
                ...
                },
                {
                    "mRender": function (data, type, row) {
                        ...
                        if(sendPromocodeSource){
                            html += '<a href="javascript:void(0)" class="fa fa-envelope" onclick="SendmailUsers(' + row[0] + ')" title="Click to send mail to Users"></a>&nbsp;&nbsp;';
                        }    
        ...
        // ======== Seprate Search code =========//
        $('#PromocodeList').dataTable().columnFilter({
            //sPlaceHolder: "head:after",
            aoColumns: [
                null,
                {type: "text", sSelector: "#serpromoname"},
                {type: "text", sSelector: "#serpromocode"},
                {type: "text", sSelector: "#serdiscount"},
                null,null,
    ...
    $('#PromocodeList_paginate ul li').on('click', function () {
    ...
    function SendmailUsers(id) {
        $('#ContactUsList_processing').show();
        $.ajax({
            type: "POST",
            url: '/promocode/sendPromocodeSource',
            data: "id=" + id,
            async: false, 
            headers: {
            ...
            success: function (data) {
               ...
               if (data == 1) {
                   $('#success_message').html('Promocode send to user successfully.');
