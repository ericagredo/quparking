<?php $__env->startSection('title', 'Park It - Manage User Notification'); ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">User Notification</li>
        </ol>
    </section>
    ...
    <section class="content">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group nomargin">
                                        ...
                                        <div class="" id="sernotificationtitle"> </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="form-group nomargin">
        ...
        <?php endif; ?>
        <div class="row contentpanel hidden">
            <div class="col-xs-12 text-right margin-bottom">
                ...
                <a href="<?php echo e(url('usernotification/createNewUserNotification')); ?>" class="btn btn-primary">Add Notification</a>
            </div>
        </div>
        <!--Data Table-->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">User Notification List</h3>
                    </div>
                    <div class="box-body">
...
<script type="text/javascript">
    ...
    var addEditSource = '/usernotification/editusernotification';
    var deleteAjaxSource = '/usernotification/deleteusernotification';
    var activeInactiveAjaxSource = '/usernotification/activeInactiveusernotification';

    $(document).ready(function () {
       
        dTable = $('#NotificationList').dataTable({
            responsive: false,
            bJQueryUI: false,
            bProcessing: true,
            bServerSide: true,
            "bAutoWidth": false,
            iDisplayLength: 10,
            sAjaxSource: '/usernotification/AjaxUserNotificationList/',
            aoColumns: [
        ...
        // ======== Seprate Search code =========//
        $('#NotificationList').dataTable().columnFilter({
            //sPlaceHolder: "head:after",
            aoColumns: [
                null,
                {type: "text", sSelector: "#sernotificationtitle"},
