...
@section('title', 'QU - Edit Parking Spot')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        ...
                        @endif
                        <form role="form" id="Parking_form" method="post" action="{{ url('/parkingspot/update/'.$parking_spot->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Street Address" type="text" name="address" minlength="3" value="{{ !empty($parking_spot->address) ? $parking_spot->address : '' }}">
                                        </div>
                                    </div> 
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label>Postal Code<span class="asterisk red">*</span></label>
                                            <input class="form-control" placeholder="Postal Code" type="text" name="postal_code" minlength="3" value="{{ !empty($parking_spot->postal_code) ? $parking_spot->postal_code : '' }}">
                                        </div>
                                    </div> 
                                    <!--<div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label>Country Name<span class="asterisk red">*</span></label>
                                            <input class="form-control" placeholder="Country Name" type="text" name="country_name" id="country_name" value="{{ !empty($parking_spot->country_name) ? $parking_spot->country_name : '' }}">
                                        </div>
                                    </div>-->
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="country_id" id="country_id">
                                                ...
                                                ?>
                                                <option {{ $parking_spot->country_id == $single->id ? 'selected="selected"' : '' }} value="{{$single->id}}">{{$single->country_name}}&nbsp;-&nbsp;{{$single->country_code}}</option>
                                                <?php } } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <!--<div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="State/Province/Region Name" type="text" name="state_name" id="state_name" minlength="3" value="{{ !empty($parking_spot->state_name) ? $parking_spot->state_name : '' }}"> 
                                        </div>
                                    </div>-->
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="City Name" type="text" name="city_name" minlength="3" value="{{ !empty($parking_spot->city_name) ? $parking_spot->city_name : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label>Location <span class="asterisk red">*</span></label>
                                            <input class="form-control" placeholder="Location" type="text" name="location" id="location" value="{{ !empty($parking_spot->location) ? $parking_spot->location : '' }}">
                                            <input class="form-control" type="hidden" name="latitude" id="latitude" value="{{ !empty($parking_spot->latitude) ? $parking_spot->latitude : '' }}">
                                            <input class="form-control" type="hidden" name="longitude" id="longitude" value="{{ !empty($parking_spot->longitude) ? $parking_spot->longitude : '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 hidden">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Number of Space per spot" type="text" name="number_of_space_spot" onkeypress="return isNumber(event)" value="{{ !empty($parking_spot->number_of_space_spot) ? $parking_spot->number_of_space_spot : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="status">
                                                ...
                                                <option {{ ($parking_spot->status == 'Active') ? 'selected="selected"' : '' }} value="active">Active</option>
                                                <option {{ ($parking_spot->status == 'Inactive') ? 'selected="selected"' : '' }} value="inactive">Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="verification_status">
                                                ...
                                                <option {{ ($parking_spot->verification_status == 'Yes') ? 'selected="selected"' : '' }} value="Yes">Verified</option>
                                                <option {{ ($parking_spot->verification_status == 'No') ? 'selected="selected"' : '' }} value="No">Verification Pending</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Access Instruction/Notes" name="description">{{ !empty($parking_spot->description) ? $parking_spot->description : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div style="clear:both"></div>
