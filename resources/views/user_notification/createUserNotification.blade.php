...
@section('title', 'QU - Add User Notification')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ url('usernotification/manageusernotification') }}">User Notification</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                           ...
                           <form role="form" id="Form_Control" method="post" action="{{ url('/usernotification/create') }}">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                            ...
                            <div class="box-footer">
                                <a href="{{ url('usernotification/manageusernotification') }}"><button class="btn btn-default pull-right" style="margin:0 0 0 5px" type="button">Cancel</button></a>
