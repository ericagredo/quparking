...
@section('title', 'QU - Report Receipt')
    ...
    <div class="row" style="margin-top: 15px">
        <div class="col-xs-12">
            <div class="box box-primary box-solid">
                <form role="form" id="ReceiptForm" method="post" action="{{ url('/reports/Savereceiptreports/'.$admin_fund_managment_id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div style="margin: 20px">  
                                <a href="{{ url('reports/reportListAdmin') }}" class="btn btn-default pull-right" style="margin:0 0 0 5px">Cancel</a>
