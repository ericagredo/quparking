...
@section('title', 'QU - Add Review Questionnaires')
@section('content')
                ...
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Review Questionnaires</h3>
                        </div>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <form role="form" id="Review_Questionnaires_form" method="post" action="{{ url('/review/create') }}">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Questionnaires Title" type="text" name="questionnaires_title" minlength="3">
                                        </div>
                                    </div> 
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
