    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ url('state/managestate') }}">State</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                           ...
                           <form role="form" id="Form_Control" method="post" action="{{ url('/state/create') }}">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="country_name">
                                                ...
                                                ?>
                                                <option value="{{$single->id}}">{{$single->country_name}}&nbsp;-&nbsp;{{$single->country_code}}</option>
                                                <?php } } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                <a href="{{ url('state/managestate') }}"><button class="btn btn-default pull-right" style="margin:0 0 0 5px" type="button">Cancel</button></a>
